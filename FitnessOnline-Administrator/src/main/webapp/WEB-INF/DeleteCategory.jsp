...
<body>
	<%@ include file="Header.jsp" %>
		...
		<div class="content">
			...
			<div class="title"> Delete A Category </div> 
			
			<form action="?action=SendCategoryDelete" method="POST" class="my-form">
				
				<div class="mb-3">
					<label for="id" class="form-label">Category ID</label>
					<input type="number" class="form-control login-input" name="id" id="id" required>
				</div>
