...
<body>
	<%@ include file="Header.jsp" %>
		...
		<div class="content">
			...
			<div class="title"> Update A User </div> 
			
			
			<form action="?action=SendUserUpdate" method="POST" class="my-form">
		        ...
		        <div class="mb-3">
		            <label for="city" class="form-label">Edit City</label>
		            <input type="text" name="city" class="form-control signup-input" id="city" required>
		        </div>
		        
		        <div class="mb-3">
		            <label for="avatar" class="form-label">Upload a New Avatar Photo</label>
		        ...
		        <div class="mb-3">
		            <label for="contact" class="form-label">Edit Contact info</label>
