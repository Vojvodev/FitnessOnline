...
<html>
	...
	<body>
		<nav class="welcome-title">
			<div class="line">
				Fitness Online - Trainer App
			</div>
			
			<div class="logout">
				<%
					TrainerBean trainer1 = (TrainerBean) session.getAttribute("trainer");
					if(trainer1 != null && trainer1.isLoggedIn()){ 
				%> 
						<a class="logout-link" href="Logout.jsp">LOG OUT
